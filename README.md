...
| モデル | ランタイム | 用途 | 状態 |
|--------|-----------|------|------|
| Bonsai 8B (1-bit) | Ollama on Docker | 超軽量・汎用（1.15GB） | 試験中 |
...
### Bonsai 8B (1-bit) を起動する

PrismML の 1-bit Bonsai 8B モデル。わずか **1.15 GB** で動作する超軽量モデル。  
Ollama上では `digitsflow/bonsai-8b` として公開されている。
